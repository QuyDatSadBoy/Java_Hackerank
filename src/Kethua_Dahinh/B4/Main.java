...
class sinhVien extends person {
    ...
    public String toString() {
        return ma + " " + super.toString() + lop + " " + String.format("%.2f", Double.parseDouble(gpa));
    }
}
...
class giaoVien extends person {
    ...
    public giaoVien(String ten, String ngaySinh, String diaChi, String ma, String khoa, String luong, String lop) {
        super(ten, ngaySinh, diaChi);
        this.ma = ma;
        this.khoa = khoa;
        this.luong = luong;
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (ma.substring(0, 2).equals("GV")) {
                giaoVien gv = new giaoVien(ten, ns, diaChi, ma, sc.nextLine(), sc.nextLine(), sc.nextLine());
                gv.chuanHoa();
                a.add(gv);
            } else {
        ...
        System.out.println("DANH SACH GIAO VIEN CO DIA CHI TAI " + res + " :");
        for (int i = 0; i < a.size(); i++) {
            if (a.get(i) instanceof giaoVien && a.get(i).diaChi.equals(res)) {
                System.out.println(a.get(i));
            }
        }
        System.out.println("DANH SACH SINH VIEN CO DIA CHI TAI " + res + " :");
        for (int i = 0; i < a.size(); i++) {
            if (a.get(i) instanceof sinhVien && a.get(i).diaChi.equals(res)) {
                System.out.println(a.get(i));
            }
        }
    }
